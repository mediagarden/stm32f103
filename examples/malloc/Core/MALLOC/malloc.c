...
//内存池(32字节对齐)
//u8 srambase[MEM2_MAX_SIZE + MEM2_ALLOC_TABLE_SIZE] __attribute__((section(".sram")));

#pragma pack(4)
u8 mem1base[MEM1_MAX_SIZE];																	//内部SRAM内存池
u8 mem2base[MEM2_MAX_SIZE] __attribute__((section(".sram_mem")));							//外部SRAM内存池
#pragma pack()
//内存管理表
u16 mem1mapbase[MEM1_ALLOC_TABLE_SIZE];														//内部SRAM内存池MAP
u16 mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((section(".sram_tbl")));				//外部SRAM内存池MAP
